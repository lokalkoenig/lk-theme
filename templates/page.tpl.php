...
<div id="page" class="clearfix">
  ...
  <div id="main" >
    ...
    <div id="content" class="column" role="main">
      <a id="main-content"></a>
       <?php 
        $st = render($page['search_top']); 
        if($st AND !lk_search_has_no_results()){
           print $st;
        }
       
       ?>
      <?php print render($page['content']); ?>
      <?php if ($action_links AND false): ?>
        <div class="panel"><div class="panel-body"><ul class="action-links"><?php print render($action_links); ?></ul></div></div>
      <?php endif; ?>
    </div>
  </div>
